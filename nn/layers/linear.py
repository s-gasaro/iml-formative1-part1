    ...
    def __init__(self, in_features: int, out_features: int) -> None:
        ...
        Sets:
            self.W (np.ndarray): weight matrix, shape
                ...
                not zeros.
            self.b (np.ndarray): bias vector, shape (out_features,).
                Initialized to zero.
    ...
    def backward(self, grad_output: np.ndarray) -> np.ndarray:
        ...
        Args:
            grad_output (np.ndarray): gradient of the loss with respect
                to this layer's output, shape (batch_size, out_features).
        ...
        Sets:
            self.dW (np.ndarray): overwritten in place, not reassigned.
